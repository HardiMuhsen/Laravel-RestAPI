...
class api extends Controller
{
    ...
    public function sendVerificationEmail(Request $request) {
        ...
        if($request->user()->hasVerifiedEmail()){
            ...
            return response()->json("Email Verification link sent to your email", 200);
        }
    ...
    public function reset(Request $request) {
        ...
        if(!$validator->fails()) {
            ...
            if($status == Password::PASSWORD_RESET) {
                ...
                return response()->json(['succes' => __('passwords.reset')], 200);
            }else {
    ...
    public function home(Request $request) {
        ...
        return [
            ...
            //'populer' => properties::latest()->take(7)->orderBy('price', 'desc')->get(),
        ];
    }
    ...
    {
        $property = properties::with(['category', 'user', 'city'])->findOrFail($request->id);
        if($property) {
        return $property;
        }
        else {
    ...
    {
        return User::with(['properties'])->findOrFail($request->id);
    }
