...
Route::group(['middleware' => ['json']], function() {
    ...
    Route::post('forget',[App\Http\Controllers\Api\api::class, 'forget']);
    ...
    Route::group(['middleware' => ['auth:sanctum']], function(){
        ...
        Route::post('profile/properties/{id}/image', [App\Http\Controllers\Api\api::class, 'Addimage']);
        Route::delete('profile/properties/{id}', [App\Http\Controllers\Api\api::class, 'DeleteProperties']);
